...
- `cluster_storage_configuration` (List of Object) (see [below for nested schema](#nestedobjatt--cluster_info--configuration--cluster_storage_configuration))
...
<a id="nestedobjatt--cluster_info--configuration--cluster_storage_configuration"></a>
### Nested Schema for `cluster_info.configuration.cluster_storage_configuration`
...
- `audit_logging` (List of Object) (see [below for nested schema](#nestedobjatt--cluster_info--configuration--database_configuration--audit_logging))
...
<a id="nestedobjatt--cluster_info--configuration--database_configuration--audit_logging"></a>
### Nested Schema for `cluster_info.configuration.database_configuration.audit_logging`
