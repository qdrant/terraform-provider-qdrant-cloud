...
func TestAccDataAccountsRoles(t *testing.T) {
...
data "qdrant-cloud_accounts_roles" "test" {
	account_id = "%s"
}
`, os.Getenv("QDRANT_CLOUD_ACCOUNT_ID"))

	check := resource.ComposeTestCheckFunc(
		resource.TestCheckResourceAttrSet("data.qdrant-cloud_accounts_roles.test", "roles.#"),
	)
